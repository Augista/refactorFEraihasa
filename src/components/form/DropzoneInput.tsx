      ...
      {label && (
        <label htmlFor={id} className='flex space-x-1'>
          <Typography
            ...
            variant='c1'
            weight='semibold'
            className='text-sm text-primary-typo'
          >
            {label}
          </Typography>
          {validation?.required && (
              ...
              <div
                className={clsxm(
                  ...
                  error
                    ...
                    : 'group-focus:border-primary-typo group-hover:border-primary-typo',
                  className
                )}
              >
                ...
                <div className='flex flex-col items-center'>
                  ...
                  >
                    <span className='font-semibold underline text-primary-typo'>
                      Klik untuk upload
                    </span>{' '}
                    atau drag and drop
                  </Typography>
                ...
                <Typography
                  variant='c2'
                  className='text-center text-primary-typo text-xs'
                >
