      ...
      <div className='flex items-start gap-2'>
        <input
          ...
          className={clsxm(
            ...
            'checked:bg-cyan-400 checked:hover:bg-cyan-600 checked:focus:bg-cyan-400 checked:active:bg-cyan-700',
            readOnly &&
              'cursor-not-allowed bg-gray-100 disabled:checked:bg-cyan-300',
