...
export default withAuth(DashboardInterviewPage, 'user');
function DashboardInterviewPage() {
  return (
    <AdminDashboard
    ...
    >
      <div className='flex md:flex-row flex-col max-md:gap-2 justify-between items-center'>
        ...
        >
          Program Interview Boost Raihasa
        </Typography>
      </div>
      <div className='flex flex-col gap-4'>
        ...
        <DashboardTableContainer event='interview' />
      </div>
    </AdminDashboard>
  );
}
