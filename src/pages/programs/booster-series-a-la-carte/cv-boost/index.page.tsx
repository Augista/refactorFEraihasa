...
export default function CvBoost() {
  ...
  return (
    <Layout withNavbar={true} withFooter={true}>
      <SEO title='Program CV Boost' />
      <main className='scroll-smooth overflow-hidden bg-[#fff] font-[Poppins]'>
        <section className='relative overflow-hidden mt-12 md:mt-20 lg:mt-28'>
          <NextImage
          ...
          <div className='flex flex-col items-center left-1/2 -translate-x-1/2 absolute top-1/2 -translate-y-1/2 z-20'>
            <div
              className='bg-[#FB991A] px-3 w-[303px] lg:w-[879px] py-3 text-center'
              data-aos='zoom-in'
              data-aos-delay='400'
            >
              <Typography
            ...
            >
              <b>CV Boost</b> adalah layanan yang membantu pendaftar beasiswa
              <b>meningkatkan kualitas Curriculum Vitae</b> mereka dengan{' '}
          ...
          <div className='relative' data-aos='zoom-in'>
            ...
            <div className='flex relative flex-col xl:flex-row justify-center place-items-center'>
              ...
              <div className='relative -translate-y-2/3 lg:-translate-y-1/4'>
                ...
                >
                  <b>CV Boost</b> adalah salah satu dari Booster Series: A La
                  Carte yang merupakan layanan yang membantu pendaftar beasiswa
                  meningkatkan kualitas CV mereka dengan{' '}
                  <b>proofreading dan feedback</b> dalam memastikan sesuai
                  kriteria CV yang profesional.
                </Typography>
              </div>
              <div className=''>
                <NextImage
          ...
          <div className='flex flex-col lg:flex-row justify-center gap-9 max-lg:gap-5 relative max-lg:px-4'>
            ...
            >
              <Typography variant='h4' weight='bold' className='text-xl'>
                Kenapa harus CV Boost Raih Asa?
              </Typography>
              <ul className='list-disc ml-4'>
                <li>
                  <Typography>
                    Layanan Express 48 Jam: Tidak perlu tunggu lama lama. CV
                ...
                <li>
                  <Typography>
                    ...
                    review mendalam dari para ahli yang tahu persis apa yang
                    dicari HRD.
                  </Typography>
                </li>
                <li>
                  <Typography>
                    ...
                    rahasia sukses langsung dari profesional dengan saran yang
                ...
                <li>
                  <Typography>
                    CV Jadi Makin Profesional: Bantu CV kamu tampil keren dan
                    memikat, siap mencuri perhatian di mata HRD.
                  </Typography>
                </li>
              </ul>
              <Typography
              ...
              <ButtonLink
                href='/programs/booster-series-a-la-carte/cv-boost/invoice-detail'
                variant='warning'
                size='base'
              >
                Daftar Sekarang
        ...
        {/* <section className='relative pb-20 lg:pb-0  lg:h-screen bg-gradient-to-b from-[#FB991A] to-[#E47F1A] grid place-items-center'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center justify-center flex-col lg:flex-row'>
            <div className='relative flex'>
              <div className='relative -translate-y-0 lg:translate-y-1/4'>
                <NextImage
