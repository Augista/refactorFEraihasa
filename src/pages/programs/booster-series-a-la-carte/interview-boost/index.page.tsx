...
export default function InterviewBoost() {
  React.useEffect(() => {
    Aos.init({ once: true });
  }, []);
  ...
  return (
    <Layout withNavbar={true} withFooter={true}>
      <SEO title='Program Interview Boost' />
        ...
        <section className='relative overflow-hidden mt-20'>
          ...
          <div className='flex flex-col items-center left-1/2 -translate-x-1/2 absolute top-1/2 -translate-y-1/2 z-20'>
            ...
            <Typography
              ...
              data-aos-delay='600'
            >
              <b>Interview Boost</b> memberikan{' '}
              <b>pelatihan wawancara beasiswa</b> oleh awardee untuk
              mempersiapkan wawancara beasiswa.
            </Typography>
            <div className='flex mt-12 gap-2 lg:gap-12 flex-col lg:flex-row'>
              ...
              <ButtonLink
                ...
                variant='unstyled'
                size='lg'
                href='interview-boost/invoice-detail'
                data-aos='zoom-in'
                data-aos-delay='1000'
              >
                Daftar Sekarang
          ...
          <div className='relative' data-aos='zoom-in'>
            ...
            <div className='flex relative flex-col xl:flex-row justify-center place-items-center'>
              ...
              <div className='relative -translate-y-2/3 lg:-translate-y-1/4'>
                ...
                >
                  <b>Interview Boost</b> memberikan{' '}
                  <b>pelatihan wawancara beasiswa</b>
                  oleh awardee untuk mempersiapkan pendaftar menghadapi
                  pertanyaan wawancara yang mungkin diajukan,{' '}
                  <b>mengasah keterampilan</b> berbicara, dan{' '}
                  <b>memberikan feedback</b> untuk meningkatkan percaya diri
                  mereka dalam wawancara beasiswa.
                </Typography>
              </div>
              <div className=''>
                <NextImage
            ...
            <div className='flex flex-col gap-9'>
              ...
              >
                ...
                >
                  ...
                  <b>meningkatkan pembuatan CV yang profesional</b>
                </Typography>
              </div>
              <div
          ...
          <div className='flex flex-col lg:flex-row justify-center gap-9 max-lg:gap-5 relative max-lg:px-4'>
            ...
            >
              <Typography variant='h4' weight='bold' className='text-xl'>
                Kenapa harus Interview Boost Raih Asa?
              </Typography>
              <ul className=' list-disc ml-4'>
                <li>
                  <Typography>
                    Mock Up Interview: Simulasi wawancara interaktif bersama
                    mentor berpengalaman untuk tampil lebih prima dan percaya
                    diri saat wawancara sebenarnya
                  </Typography>
                </li>
                <li>
                  <Typography>
                    ...
                    persis apa yang dicari HRD ataupun penyelenggara beasiswa.
                  </Typography>
                </li>
                <li>
                  <Typography>
                    Tips dan Trik Terpersonalisasi dari Interviewer: Belajar
                ...
                <li>
                  <Typography>
                    Harga Ramah di Kantong: Layanan premium interaktif dengan
                    harga yang bersahabat.
                  </Typography>
                </li>
                <li>
                  <Typography>
                    Tambah Jago Interview: Bantu kamu tampil keren saat
                    interview, siap mencuri perhatian di mata HRD maupun
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center justify-center flex-col lg:flex-row'>
            <div className='relative flex'>
              ...
              <NextImage
                ...
                height={306}
                alt='Haira'
                className='absolute bottom-0 lg:bottom-auto lg:top-0 right-1/2 w-[151px] lg:w-[302px]'
              />
            </div>
