              ...
              <div className=' rounded-lg mt-6 xl:mt-0 pb-16 py-8 px-4 md:px-8 flex flex-col gap-4 xl:gap-8 xl:-translate-y-[83px] bg-white'>
                ...
                <div className='flex flex-col gap-4'>
                  ...
                  <Typography className='max-w-3xl text-[#4C4E60] text-xs'>
                    Layanan simulasi interview secara interaktif dan
                    profesional. Melalui zoom, mentor sebaya berpengalaman akan
                    menilai kemampuan interview kamu serta memberikan feedback
                    konstruktif untuk memastikan skill interview kamu makin
                    memukau.
                  </Typography>
                </div>
                <hr />
                <div className='flex flex-col'>
                  ...
                  <ul className='mt-6 flex flex-col gap-4 max-w-sm'>
                    <li className='flex items-center gap-3'>
                      ...
                      >
                        Mendapatkan bimbingan untuk meningkatkan kemampuan
                        interview secara professional.
                      </Typography>
                    </li>
                    <li className='flex items-center gap-3'>
                      <div className=''>
                      ...
                      <Typography
                        ...
                        className='text-xs md:text-sm md:whitespace-nowrap'
                      >
                        Mengetahui bagaimana teknik dan tips interview dari
                        awardee beasiswa.
                      </Typography>
                    </li>
                  </ul>
                  ...
                  <div className='flex gap-3 mt-3 md:flex-row flex-col'>
                    {paketData?.map((item) => (
                      <PilihanPaket
                        key={item.id}
                        title={item.name}
                        description='Simulasi inteview online.'
                        originalPrice={
