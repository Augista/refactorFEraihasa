...
import { DOCS_CAMP, TESTIMONIALS_CAMP } from '@/contents/scholarship-fair';
import Layout from '@/layouts/Layout';
export default function ScholarshipCamp() {
  ...
  return (
    <Layout withNavbar={true} withFooter={true}>
      ...
      <main className='scroll-smooth overflow-hidden bg-[#fff] font-[Poppins]'>
        <section className='relative overflow-hidden md:h-screen lg:h-auto md:mt-20 lg:mt-28'>
          <NextImage
            src={'/images/detail-program/Ornaments.png'}
            width={1563}
            height={580}
            alt='Ornaments'
            className='hidden md:block object-cover h-full 2xl:hidden'
            data-aos='zoom-in'
          />
          <NextImage
            src={'/images/detail-program/Ornaments.png'}
          ...
          <div className='flex flex-col items-center left-1/2 -translate-x-1/2 absolute top-1/2 -translate-y-1/2 z-20'>
            ...
            <Typography
              variant='p'
              className='text-center text-sm md:text-xl max-w-[277px] md:max-w-2xl mt-7'
              data-aos='zoom-in'
              data-aos-delay='600'
            >
              <b>Scholarship Camp atau Kelas pendampingan</b> merupakan{' '}
              <b>kelas intensif</b> untuk mempersiapkan pemberkasan, dan
              proofread esai yang dipandu oleh mentor sebaya{' '}
              <b>secara 1 on 1.</b>
            </Typography>
            <Button
        ...
        >
          ...
          >
            ...
            />
            <div className='flex flex-col relative xl:flex-row justify-center place-items-center'>
              <NextImage
              ...
              <div className='relative -translate-y-2/3 lg:-translate-y-1/4'>
                <NextImage
                  ...
                  height={378}
                  alt='Text Background'
                  className='w-[353px] md:w-[540px] lg:w-[705px]'
                />
                <Typography
                  variant='p'
                  className='absolute z-20 top-1/2 max-w-[608px] -translate-y-1/2 w-[331px] md:w-[80%] lg:w-full right-1/2 translate-x-1/2 text-sm lg:text-[28px] leading-4 lg:leading-7 text-center font-medium'
                >
                  <b> Scholarship Camp atau Kelas Pendampingan</b> ini merupakan
                  salah satu kegiatan Scholarship Fair dimana memberikan{' '}
                  <b>kelas intensif untuk mempersiapkan beasiswa</b> mulai dari
                  persiapan berkas hingga proofread esai untuk beasiswa yang{' '}
                  <b>
                    dipandu oleh mentor sebaya dimana merupakan awardee beasiswa
                    secara 1 on 1
                  </b>
                </Typography>
              </div>
          ...
          <div className='flex place-items-center justify-center flex-col xl:flex-row items-center gap-[56px] md:gap-[143px]'>
            ...
            <div className='flex flex-col gap-9'>
              <div
                data-aos='fade-up'
                data-aos-delay='200'
                className='w-[262px] md:w-[523px] h-[120px] lg:h-[160px] bg-[#E94759] grid place-items-center rounded-3xl px-4'
              >
                <Typography
                  variant='p'
                  className='text-white font-medium text-sm lg:text-[28px] !leading-8 text-center'
                >
                  Mendapatkan <b>Pendampingan Persiapan Beasiswa</b> secara
                  intensif
                </Typography>
              </div>
              <div
                data-aos='fade-up'
                data-aos-delay='400'
                className='w-[262px] md:w-[523px] h-[120px] lg:h-[160px] border-[6px] border-[#E94759] grid place-items-center rounded-3xl px-5'
              >
                <Typography
                  variant='p'
                  className='font-medium text-sm lg:text-[28px] !leading-8 text-center'
                >
                  Dibimbing langsung oleh <b>awardee beasiswa tahun lalu</b>{' '}
                  secara 1 on 1
                </Typography>
              </div>
            </div>
        ...
        <section className='bg-[#E94759] py-12 relative'>
          <div className='relative flex flex-col w-10/12 mx-auto h-auto justify-center items-center gap-9 mb-[93px]'>
            ...
            <div className='relative w-11/12 mx-auto flex flex-row mt-10'>
              ...
              >
                {TESTIMONIALS_CAMP.map((testimonial, index) => (
                  <SwiperSlide
                    key={index}
                  ...
                  >
                    <div className='flex flex-col gap-y-10 h-full justify-between'>
                      <div className='block'>
                        <Typography
                          variant='p'
                          className='font-secondary text-sm md:text-lg text-black-200'
                        >
