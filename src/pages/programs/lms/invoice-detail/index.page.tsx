...
import Bayar from '@/pages/programs/lms/invoice-detail/components/Bayar';
import Detail from '@/pages/programs/lms/invoice-detail/components/Detail';
...
export default withAuth(CheckoutLMS, 'user');
function CheckoutLMS() {
