...
import { PaketProps } from '@/pages/programs/lms/invoice-detail/index.page';
              ...
              <div className=' rounded-lg mt-6 xl:mt-0 pb-16 py-8 px-4 md:px-8 flex flex-col gap-4 xl:gap-8 xl:-translate-y-[83px] bg-white'>
                ...
                <div className='flex flex-col gap-4'>
                  ...
                  <Typography className='max-w-3xl text-[#4C4E60] text-xs'>
                    ...
                    adalah platform inovatif yang membantu mempersiapkan
                    pendaftaran beasiswa dengan course seru yang bisa diakses
                ...
                <div className='flex flex-col'>
                  ...
                  <ul className='mt-6 flex flex-col gap-4 max-w-sm'>
                    <li className='flex items-center gap-3'>
                      ...
                      >
                        Materi profesional yang dapat diakses kapanpun dan
                        dimanapun
                      </Typography>
                    </li>
                    <li className='flex items-center gap-3'>
                      ...
                      <Typography
                        ...
                        className='text-xs md:text-sm md:whitespace-nowrap'
                      >
                        Konten relevan dan terarah yang dirancang khusus sesuai
                        kebutuhanmu
                      </Typography>
                    </li>
                  </ul>
                ...
                <div className='flex justify-between'>
                  ...
                  >
                    Rp{paket?.harga_diskon.toLocaleString('id-ID')}
                  </Typography>
                </div>
              </div>
            </div>
